...
export const GAME_SYSTEMS: Record<string, GameSystemConfig> = {
  ...
  V20: {
    ...
    nav: [
      ...
      { id: 'factions',   label: 'Clanes',                    icon: 'skull',       href: '/clanes' },
  ...
  W20: {
    ...
    nav: [
      ...
      { id: 'factions',   label: 'Tribus',                icon: 'shield',    href: '/tribus' },
  ...
  M20: {
    ...
    nav: [
      ...
      { id: 'factions',   label: 'Tradiciones',           icon: 'layers',    href: '/tradiciones' },
  ...
  C20: {
    ...
    nav: [
      ...
      { id: 'factions',   label: 'Parentelas',            icon: 'heart',     href: '/parentelas' },
  ...
  Wr20: {
    ...
    accent: {
      primary: '#708090',
      dim:     'rgba(112,128,144,0.12)',
      border:  'rgba(112,128,144,0.35)',
    },
    nav: [
      { id: 'home',       label: 'Inicio',               icon: 'home',      href: '/' },
      { id: 'system',     label: 'Sistema Básico',        icon: 'book',      href: '/sistema' },
      ...
      { id: 'factions',   label: 'Gremios',               icon: 'award',     href: '/gremios' },
